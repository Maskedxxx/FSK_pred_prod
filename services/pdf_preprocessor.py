...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--cleanup",
        action="store_true",
        help="Удалить временную папку (workdir) после завершения.",
    )
    ...
    # Sanity-проверка: все файлы реально созданы.
    missing = []
...
# Примеры запуска:
#
# python services/pdf_preprocessor.py "файл.pdf"
# python services/pdf_preprocessor.py "файл.pdf" --max-pages 2
# python services/pdf_preprocessor.py "файл.pdf" --cleanup
# python services/pdf_preprocessor.py "файл.pdf" --max-pages 5 --cleanup
